...
- **Remove** a clothing item and its attributes (including images) from the catalogue (**Crimson Red Button**).   
...
- **Click** on an image to view it in fullscreen with a detailed description.  
